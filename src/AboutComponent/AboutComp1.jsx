  ...
  return (
    <>
      <main className='pg grid justify-center items-center h-[250px] mb-1'>
        <h2 className='text-xl md:text-2xl lg:text-4xl font-bold text-white pt-7'>About Agency</h2>
        <div className='flex justify-center items-center gap-1'>
        <h2 className='text-orange-400'>Home /</h2><h2 className='text-white'> About</h2>
        </div>
      </main>

      <main className='h-[1000px] md:h-[750px] lg:h-[550px]'>
        <div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-2'>
            <div className='md:ml-9 mt-10'> 
                <img className='h-[100%] lg:ml-10' src="https://livedemo00.template-help.com/wt_prod-18389/images/about-01-470x310.jpg"/>
            </div>
            <div>
